...
public class TelaCliente extends javax.swing.JPanel {
    ...
    private void inicializarClienteTeste() {
        ...
        if (!clientes.isEmpty()) {
            ...
            // Encontrar conta deste cliente
            for (Conta conta : contas) {
                if (conta.getClienteId().getIdCliente() == clienteLogado.getIdCliente()) {
            ...
            this.clienteLogado = sistemaController.criarCliente(
                "João Silva", 123456789, "Maputo", 841234567, 
    ...
    private void configurarListeners() {
        ...
        // jButton2 REMOVIDO - Depósito (como solicitado)
